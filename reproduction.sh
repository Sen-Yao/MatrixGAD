...
python run.py --batch_size=32768 --dataset=elliptic --end_lr=0.0003 --lambda_rec_emb=2 --num_epoch=150 --outlier_beta=0.3 --peak_lr=0.0005 --pp_k=6 --progregate_alpha=0.6 --rec_loss_weight=1 --ring_R_max=1 --ring_R_min=0.3 --ring_loss_weight=20 --seed=1 --train_rate=0.05 --warmup_updates=50

## photo

## 0.91

python run.py --batch_size=128 --dataset=photo --end_lr=1e-4 --lambda_rec_emb=0.1 --num_epoch=200 --peak_lr=5e-4 --pp_k=6 --progregate_alpha=0.2 --rec_loss_weight=1 --ring_R_max=1 --ring_R_min=0.3 --ring_loss_weight=1 --seed=2 --train_rate=0.05 --warmup_updates=50

## Elliptic

## 0.95

python run.py --batch_size=32768 --dataset=elliptic --end_lr=0.0003 --lambda_rec_emb=2 --num_epoch=150 --outlier_beta=0.3 --peak_lr=0.0005 --pp_k=7 --progregate_alpha=0.6 --rec_loss_weight=1 --ring_R_max=1 --ring_R_min=0.3 --ring_loss_weight=20 --seed=0 --train_rate=0.1 --warmup_updates=50
